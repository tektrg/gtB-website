---
title: "How to set up submodel in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect submodel to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-25T00:00:00.000Z
updatedDate: 2026-03-25
topicId: "provider-submodel"
tags: ["providers", "submodel", "byom", "api-keys"]
draft: false
---

# How to set up submodel in GPT Breeze (API key + custom model)

Connecting **submodel** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
2) In **GPT Breeze → Settings → Credentials (Providers)**, add a credential.
   ...
   - **Base URL:** `https://llm.submodel.ai/v1`
   - **API key:** your submodel key
...
submodel is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://submodel.gitbook.io
- Common env vars (from our catalog): `SUBMODEL_INSTAGEN_ACCESS_KEY`

## When to use it

- You already use submodel and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `zai-org/GLM-4.5-Air`
