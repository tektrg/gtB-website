---
title: "How to set up IO.NET in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect IO.NET to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-17T00:00:00.000Z
updatedDate: 2026-03-17
topicId: "provider-io-net"
tags: ["providers", "io-net", "byom", "api-keys"]
draft: false
---

# How to set up IO.NET in GPT Breeze (API key + custom model)

Connecting **IO.NET** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
IO.NET is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://io.net/docs/guides/intelligence/io-intelligence
- Common env vars (from our catalog): `IOINTELLIGENCE_API_KEY`

## When to use it

- You already use IO.NET and want to keep your GPT Breeze setup consistent.
