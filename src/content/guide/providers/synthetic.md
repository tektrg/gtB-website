---
title: "How to set up Synthetic in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect Synthetic to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-13T00:00:00.000Z
updatedDate: 2026-03-13
topicId: "provider-synthetic"
tags: ["providers", "synthetic", "byom", "api-keys"]
draft: false
---

# How to set up Synthetic in GPT Breeze (API key + custom model)

Connecting **Synthetic** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
Synthetic is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://synthetic.new/pricing
- Common env vars (from our catalog): `SYNTHETIC_API_KEY`

## When to use it

- You already use Synthetic and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `hf:MiniMaxAI/MiniMax-M2.5`
