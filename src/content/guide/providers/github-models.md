---
title: "How to set up GitHub Models in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect GitHub Models to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-05T00:00:00.000Z
updatedDate: 2026-03-05
topicId: "provider-github-models"
tags: ["providers", "github-models", "byom", "api-keys"]
draft: false
---

# How to set up GitHub Models in GPT Breeze (API key + custom model)

Connecting **GitHub Models** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
2) In **GPT Breeze → Settings → Credentials (Providers)**, add a credential.
   ...
   - **API key:** your GitHub Models key
...
GitHub Models is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://docs.github.com/en/github-models
- Common env vars (from our catalog): `GITHUB_TOKEN`

## When to use it

- You already use GitHub Models and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `ai21-labs/ai21-jamba-1.5-mini`
