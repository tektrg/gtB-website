---
title: "How to set up Azure Cognitive Services in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect Azure Cognitive Services to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-02-27T00:00:00.000Z
updatedDate: 2026-02-27
topicId: "provider-azure-cognitive-services"
tags: ["providers", "azure-cognitive-services", "byom", "api-keys"]
draft: false
---

# How to set up Azure Cognitive Services in GPT Breeze (API key + custom model)

Connecting **Azure Cognitive Services** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
2) In **GPT Breeze → Settings → Credentials (Providers)**, add a credential.
   ...
   - **API key:** your Azure Cognitive Services key
...
Azure Cognitive Services is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models
- Common env vars (from our catalog): `AZURE_COGNITIVE_SERVICES_RESOURCE_NAME`, `AZURE_COGNITIVE_SERVICES_API_KEY`

## When to use it

- You already use Azure Cognitive Services and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `claude-opus-4-1`
