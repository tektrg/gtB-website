---
title: "How to set up Nebius Token Factory in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect Nebius Token Factory to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-09T00:00:00.000Z
updatedDate: 2026-03-09
topicId: "provider-nebius"
tags: ["providers", "nebius", "byom", "api-keys"]
draft: false
---

# How to set up Nebius Token Factory in GPT Breeze (API key + custom model)

Connecting **Nebius Token Factory** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
Nebius Token Factory is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://docs.tokenfactory.nebius.com/
- Common env vars (from our catalog): `NEBIUS_API_KEY`

## When to use it

- You already use Nebius Token Factory and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `zai-org/glm-4.7-fp8`
