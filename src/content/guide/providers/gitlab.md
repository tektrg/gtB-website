---
title: "How to set up GitLab Duo in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect GitLab Duo to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-24T00:00:00.000Z
updatedDate: 2026-03-24
topicId: "provider-gitlab"
tags: ["providers", "gitlab", "byom", "api-keys"]
draft: false
---

# How to set up GitLab Duo in GPT Breeze (API key + custom model)

Connecting **GitLab Duo** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
GitLab Duo is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://docs.gitlab.com/user/duo_agent_platform/
- Common env vars (from our catalog): `GITLAB_TOKEN`

## When to use it

- You already use GitLab Duo and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `duo-chat-gpt-5-2-codex`
