---
title: "How to set up Scaleway in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect Scaleway to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-18T00:00:00.000Z
updatedDate: 2026-03-18
topicId: "provider-scaleway"
tags: ["providers", "scaleway", "byom", "api-keys"]
draft: false
---

# How to set up Scaleway in GPT Breeze (API key + custom model)

Connecting **Scaleway** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
Scaleway is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://www.scaleway.com/en/docs/generative-apis/
- Common env vars (from our catalog): `SCALEWAY_API_KEY`

## When to use it

- You already use Scaleway and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `voxtral-small-24b-2507`
