---
title: "How to set up Jiekou.AI in GPT Breeze (API key + custom model)"
description: "A practical setup guide to connect Jiekou.AI to GPT Breeze: add credentials, create a custom model, and avoid the common BYOK mistakes."
pubDate: 2026-03-04T00:00:00.000Z
updatedDate: 2026-03-04
topicId: "provider-jiekou"
tags: ["providers", "jiekou", "byom", "api-keys"]
draft: false
---

# How to set up Jiekou.AI in GPT Breeze (API key + custom model)

Connecting **Jiekou.AI** to GPT Breeze is simple in theory: paste a key, pick a model, done. In practice, most failures come from one of three things: the wrong base URL, the wrong model id, or a key that doesn’t have access. This guide is the “do this, not that” version.
...
Jiekou.AI is a provider you can connect to GPT Breeze as part of a BYOK/BYOM workflow.

- Provider docs: https://docs.jiekou.ai/docs/support/quickstart?utm_source=github_models.dev
- Common env vars (from our catalog): `JIEKOU_API_KEY`

## When to use it

- You already use Jiekou.AI and want to keep your GPT Breeze setup consistent.
...
If you just want to validate your setup quickly, start with: `grok-4-fast-non-reasoning`
