---
title: "Llama 3.3 70B Versatile pricing (input/output per 1M tokens)"
description: "Current Groq pricing for Llama 3.3 70B Versatile: input $0.59/1M tokens, output $0.79/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-18T00:00:00.000Z
topicId: "model-pricing-groq-llama-3-3-70b-versatile"
tags: ["pricing", "models", "groq", "llama-3-3-70b-versatile"]
faq:
  - q: "How much does Llama 3.3 70B Versatile cost?"
    a: "List price is $0.59/1M input tokens and $0.79/1M output tokens (USD)."
...
# Llama 3.3 70B Versatile pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Llama 3.3 70B Versatile** (provider: **Groq**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.59 / 1M | Prompt + system + context |
| Output tokens | $0.79 / 1M | Model responses |
...
- **100k input + 20k output** ≈ $0.075 (input $0.059 + output $0.016)
- **1M input + 200k output** ≈ $0.75 (input $0.59 + output $0.16)
