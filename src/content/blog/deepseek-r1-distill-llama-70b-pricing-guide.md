---
title: "DeepSeek R1 Distill Llama 70B pricing (input/output per 1M tokens)"
description: "Current Groq pricing for DeepSeek R1 Distill Llama 70B: input $0.75/1M tokens, output $0.99/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-18T00:00:00.000Z
topicId: "model-pricing-groq-deepseek-r1-distill-llama-70b"
tags: ["pricing", "models", "groq", "deepseek-r1-distill-llama-70b"]
faq:
  - q: "How much does DeepSeek R1 Distill Llama 70B cost?"
    a: "List price is $0.75/1M input tokens and $0.99/1M output tokens (USD)."
...
# DeepSeek R1 Distill Llama 70B pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **DeepSeek R1 Distill Llama 70B** (provider: **Groq**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.75 / 1M | Prompt + system + context |
| Output tokens | $0.99 / 1M | Model responses |
...
- **100k input + 20k output** ≈ $0.095 (input $0.075 + output $0.02)
- **1M input + 200k output** ≈ $0.95 (input $0.75 + output $0.20)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-18**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
