---
title: "GLM-4.7 pricing (input/output per 1M tokens)"
description: "Current Z.AI pricing for GLM-4.7: input $0.60/1M tokens, output $2.20/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-17T00:00:00.000Z
topicId: "model-pricing-zai-glm-4-7"
tags: ["pricing", "models", "zai", "glm-4-7"]
faq:
  - q: "How much does GLM-4.7 cost?"
    a: "List price is $0.60/1M input tokens and $2.20/1M output tokens (USD)."
...
# GLM-4.7 pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GLM-4.7** (provider: **Z.AI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.
...
| Output tokens | $2.20 / 1M | Model responses |
| Cache read | $0.11 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.10 (input $0.06 + output $0.044)
- **1M input + 200k output** ≈ $1.04 (input $0.60 + output $0.44)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-16**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
