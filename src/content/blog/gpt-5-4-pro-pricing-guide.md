---
title: "GPT-5.4 Pro pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.4 Pro: input $30/1M tokens, output $180/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-20T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-4-pro"
tags: ["pricing", "models", "openai", "gpt-5-4-pro"]
faq:
  - q: "How much does GPT-5.4 Pro cost?"
    a: "List price is $30/1M input tokens and $180/1M output tokens (USD)."
...
# GPT-5.4 Pro pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.4 Pro** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $30 / 1M | Prompt + system + context |
| Output tokens | $180 / 1M | Model responses |
...
- **100k input + 20k output** ≈ $6.60 (input $3 + output $3.60)
- **1M input + 200k output** ≈ $66 (input $30 + output $36)
