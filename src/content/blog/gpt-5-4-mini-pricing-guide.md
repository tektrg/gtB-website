---
title: "GPT-5.4 mini pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.4 mini: input $0.75/1M tokens, output $4.50/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-19T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-4-mini"
tags: ["pricing", "models", "openai", "gpt-5-4-mini"]
faq:
  - q: "How much does GPT-5.4 mini cost?"
    a: "List price is $0.75/1M input tokens and $4.50/1M output tokens (USD)."
...
# GPT-5.4 mini pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.4 mini** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.
...
| Output tokens | $4.50 / 1M | Model responses |
| Cache read | $0.075 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.17 (input $0.075 + output $0.09)
- **1M input + 200k output** ≈ $1.65 (input $0.75 + output $0.90)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-19**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
