---
title: "Grok 3 Fast pricing (input/output per 1M tokens)"
description: "Current xAI pricing for Grok 3 Fast: input $5/1M tokens, output $25/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-13T00:00:00.000Z
topicId: "model-pricing-xai-grok-3-fast"
tags: ["pricing", "models", "xai", "grok-3-fast"]
faq:
  - q: "How much does Grok 3 Fast cost?"
    a: "List price is $5/1M input tokens and $25/1M output tokens (USD)."
...
# Grok 3 Fast pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Grok 3 Fast** (provider: **xAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $5 / 1M | Prompt + system + context |
| Output tokens | $25 / 1M | Model responses |
| Cache read | $1.25 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $1 (input $0.50 + output $0.50)
- **1M input + 200k output** ≈ $10 (input $5 + output $5)
