---
title: "DeepSeek Chat pricing (input/output per 1M tokens)"
description: "Current DeepSeek pricing for DeepSeek Chat: input $0.28/1M tokens, output $0.42/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-14T00:00:00.000Z
topicId: "model-pricing-deepseek-deepseek-chat"
tags: ["pricing", "models", "deepseek", "deepseek-chat"]
faq:
  - q: "How much does DeepSeek Chat cost?"
...
# DeepSeek Chat pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **DeepSeek Chat** (provider: **DeepSeek**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-14**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
