---
title: "GPT-5.4 nano pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.4 nano: input $0.20/1M tokens, output $1.25/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-19T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-4-nano"
tags: ["pricing", "models", "openai", "gpt-5-4-nano"]
faq:
  - q: "How much does GPT-5.4 nano cost?"
    a: "List price is $0.20/1M input tokens and $1.25/1M output tokens (USD)."
...
# GPT-5.4 nano pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.4 nano** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.20 / 1M | Prompt + system + context |
| Output tokens | $1.25 / 1M | Model responses |
| Cache read | $0.02 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.045 (input $0.02 + output $0.025)
- **1M input + 200k output** ≈ $0.45 (input $0.20 + output $0.25)
