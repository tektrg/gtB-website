---
title: "Grok 4 Fast pricing (input/output per 1M tokens)"
description: "Current xAI pricing for Grok 4 Fast: input $0.20/1M tokens, output $0.50/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-12T00:00:00.000Z
topicId: "model-pricing-xai-grok-4-fast"
tags: ["pricing", "models", "xai", "grok-4-fast"]
faq:
  - q: "How much does Grok 4 Fast cost?"
    a: "List price is $0.20/1M input tokens and $0.50/1M output tokens (USD)."
...
# Grok 4 Fast pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Grok 4 Fast** (provider: **xAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.
...
| Output tokens | $0.50 / 1M | Model responses |
| Cache read | $0.05 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.03 (input $0.02 + output $0.01)
- **1M input + 200k output** ≈ $0.30 (input $0.20 + output $0.10)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-12**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
