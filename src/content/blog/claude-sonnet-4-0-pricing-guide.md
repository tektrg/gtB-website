---
title: "Claude Sonnet 4 (latest) pricing (input/output per 1M tokens)"
description: "Current Anthropic pricing for Claude Sonnet 4 (latest): input $3/1M tokens, output $15/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-10T00:00:00.000Z
topicId: "model-pricing-anthropic-claude-sonnet-4-0"
tags: ["pricing", "models", "anthropic", "claude-sonnet-4-0"]
faq:
  - q: "How much does Claude Sonnet 4 (latest) cost?"
...
# Claude Sonnet 4 (latest) pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Claude Sonnet 4 (latest)** (provider: **Anthropic**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-09**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
