---
title: "Kimi K2 Thinking Turbo pricing (input/output per 1M tokens)"
description: "Current Moonshot AI pricing for Kimi K2 Thinking Turbo: input $1.15/1M tokens, output $8/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-15T00:00:00.000Z
topicId: "model-pricing-moonshotai-kimi-k2-thinking-turbo"
tags: ["pricing", "models", "moonshotai", "kimi-k2-thinking-turbo"]
faq:
  - q: "How much does Kimi K2 Thinking Turbo cost?"
    a: "List price is $1.15/1M input tokens and $8/1M output tokens (USD)."
...
# Kimi K2 Thinking Turbo pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Kimi K2 Thinking Turbo** (provider: **Moonshot AI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $1.15 / 1M | Prompt + system + context |
| Output tokens | $8 / 1M | Model responses |
| Cache read | $0.15 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.28 (input $0.11 + output $0.16)
- **1M input + 200k output** ≈ $2.75 (input $1.15 + output $1.60)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-15**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
