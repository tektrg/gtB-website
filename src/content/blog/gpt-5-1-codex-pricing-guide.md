---
title: "GPT-5.1 Codex pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.1 Codex: input $1.25/1M tokens, output $10/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-25T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-1-codex"
tags: ["pricing", "models", "openai", "gpt-5-1-codex"]
faq:
  - q: "How much does GPT-5.1 Codex cost?"
...
# GPT-5.1 Codex pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.1 Codex** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-25**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
