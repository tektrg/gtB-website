---
title: "Kimi K2 Turbo pricing (input/output per 1M tokens)"
description: "Current Moonshot AI pricing for Kimi K2 Turbo: input $2.40/1M tokens, output $10/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-16T00:00:00.000Z
topicId: "model-pricing-moonshotai-kimi-k2-turbo-preview"
tags: ["pricing", "models", "moonshotai", "kimi-k2-turbo-preview"]
faq:
  - q: "How much does Kimi K2 Turbo cost?"
    a: "List price is $2.40/1M input tokens and $10/1M output tokens (USD)."
...
# Kimi K2 Turbo pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Kimi K2 Turbo** (provider: **Moonshot AI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $2.40 / 1M | Prompt + system + context |
| Output tokens | $10 / 1M | Model responses |
| Cache read | $0.60 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.44 (input $0.24 + output $0.20)
- **1M input + 200k output** ≈ $4.40 (input $2.40 + output $2)
