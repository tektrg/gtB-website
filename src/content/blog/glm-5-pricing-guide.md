---
title: "GLM-5 pricing (input/output per 1M tokens)"
description: "Current Z.AI pricing for GLM-5: input $1/1M tokens, output $3.20/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-16T00:00:00.000Z
topicId: "model-pricing-zai-glm-5"
tags: ["pricing", "models", "zai", "glm-5"]
faq:
  - q: "How much does GLM-5 cost?"
    a: "List price is $1/1M input tokens and $3.20/1M output tokens (USD)."
...
# GLM-5 pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GLM-5** (provider: **Z.AI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $1 / 1M | Prompt + system + context |
| Output tokens | $3.20 / 1M | Model responses |
| Cache read | $0.20 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.16 (input $0.10 + output $0.064)
- **1M input + 200k output** ≈ $1.64 (input $1 + output $0.64)
