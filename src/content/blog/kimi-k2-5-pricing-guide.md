---
title: "Kimi K2.5 pricing (input/output per 1M tokens)"
description: "Current Moonshot AI pricing for Kimi K2.5: input $0.60/1M tokens, output $3/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-15T00:00:00.000Z
topicId: "model-pricing-moonshotai-kimi-k2-5"
tags: ["pricing", "models", "moonshotai", "kimi-k2-5"]
faq:
  - q: "How much does Kimi K2.5 cost?"
    a: "List price is $0.60/1M input tokens and $3/1M output tokens (USD)."
...
# Kimi K2.5 pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Kimi K2.5** (provider: **Moonshot AI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.60 / 1M | Prompt + system + context |
| Output tokens | $3 / 1M | Model responses |
...
- **100k input + 20k output** ≈ $0.12 (input $0.06 + output $0.06)
- **1M input + 200k output** ≈ $1.20 (input $0.60 + output $0.60)
