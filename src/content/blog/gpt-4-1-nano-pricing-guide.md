---
title: "GPT-4.1 nano pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-4.1 nano: input $0.10/1M tokens, output $0.40/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-09T00:00:00.000Z
topicId: "model-pricing-openai-gpt-4-1-nano"
tags: ["pricing", "models", "openai", "gpt-4-1-nano"]
faq:
  - q: "How much does GPT-4.1 nano cost?"
    a: "List price is $0.10/1M input tokens and $0.40/1M output tokens (USD)."
...
# GPT-4.1 nano pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-4.1 nano** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.10 / 1M | Prompt + system + context |
| Output tokens | $0.40 / 1M | Model responses |
| Cache read | $0.03 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.018 (input $0.01 + output $0.008)
- **1M input + 200k output** ≈ $0.18 (input $0.10 + output $0.08)
