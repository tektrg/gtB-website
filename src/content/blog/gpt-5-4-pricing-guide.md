---
title: "GPT-5.4 pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.4: input $2.50/1M tokens, output $15/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-20T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-4"
tags: ["pricing", "models", "openai", "gpt-5-4"]
faq:
  - q: "How much does GPT-5.4 cost?"
    a: "List price is $2.50/1M input tokens and $15/1M output tokens (USD)."
...
# GPT-5.4 pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.4** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $2.50 / 1M | Prompt + system + context |
| Output tokens | $15 / 1M | Model responses |
| Cache read | $0.25 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.55 (input $0.25 + output $0.30)
- **1M input + 200k output** ≈ $5.50 (input $2.50 + output $3)
