---
title: "GPT-5.2 Pro pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.2 Pro: input $21/1M tokens, output $168/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-23T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-2-pro"
tags: ["pricing", "models", "openai", "gpt-5-2-pro"]
faq:
  - q: "How much does GPT-5.2 Pro cost?"
    a: "List price is $21/1M input tokens and $168/1M output tokens (USD)."
...
# GPT-5.2 Pro pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.2 Pro** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $21 / 1M | Prompt + system + context |
| Output tokens | $168 / 1M | Model responses |
...
- **100k input + 20k output** ≈ $5.46 (input $2.10 + output $3.36)
- **1M input + 200k output** ≈ $54.60 (input $21 + output $33.60)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-23**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
