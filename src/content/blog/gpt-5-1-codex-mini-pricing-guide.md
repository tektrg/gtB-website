---
title: "GPT-5.1 Codex mini pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.1 Codex mini: input $0.25/1M tokens, output $2/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-25T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-1-codex-mini"
tags: ["pricing", "models", "openai", "gpt-5-1-codex-mini"]
faq:
  - q: "How much does GPT-5.1 Codex mini cost?"
    a: "List price is $0.25/1M input tokens and $2/1M output tokens (USD)."
...
# GPT-5.1 Codex mini pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.1 Codex mini** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.25 / 1M | Prompt + system + context |
| Output tokens | $2 / 1M | Model responses |
| Cache read | $0.025 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.065 (input $0.025 + output $0.04)
- **1M input + 200k output** ≈ $0.65 (input $0.25 + output $0.40)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-24**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
