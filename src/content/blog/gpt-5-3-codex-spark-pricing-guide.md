---
title: "GPT-5.3 Codex Spark pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-5.3 Codex Spark: input $1.75/1M tokens, output $14/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-21T00:00:00.000Z
topicId: "model-pricing-openai-gpt-5-3-codex-spark"
tags: ["pricing", "models", "openai", "gpt-5-3-codex-spark"]
faq:
  - q: "How much does GPT-5.3 Codex Spark cost?"
    a: "List price is $1.75/1M input tokens and $14/1M output tokens (USD)."
...
# GPT-5.3 Codex Spark pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-5.3 Codex Spark** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $1.75 / 1M | Prompt + system + context |
| Output tokens | $14 / 1M | Model responses |
| Cache read | $0.17 / 1M | If provider supports cached inputs |
...
- **100k input + 20k output** ≈ $0.46 (input $0.18 + output $0.28)
- **1M input + 200k output** ≈ $4.55 (input $1.75 + output $2.80)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-21**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
