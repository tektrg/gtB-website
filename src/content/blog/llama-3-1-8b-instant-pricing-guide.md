---
title: "Llama 3.1 8B Instant pricing (input/output per 1M tokens)"
description: "Current Groq pricing for Llama 3.1 8B Instant: input $0.05/1M tokens, output $0.08/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-17T00:00:00.000Z
topicId: "model-pricing-groq-llama-3-1-8b-instant"
tags: ["pricing", "models", "groq", "llama-3-1-8b-instant"]
faq:
  - q: "How much does Llama 3.1 8B Instant cost?"
    a: "List price is $0.05/1M input tokens and $0.08/1M output tokens (USD)."
...
# Llama 3.1 8B Instant pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Llama 3.1 8B Instant** (provider: **Groq**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.05 / 1M | Prompt + system + context |
| Output tokens | $0.08 / 1M | Model responses |
...
- **100k input + 20k output** ≈ $0.007 (input $0.005 + output $0.002)
- **1M input + 200k output** ≈ $0.066 (input $0.05 + output $0.016)
...
Pricing data is pulled from GPT Breeze’s internal model catalog (`src/data/models-api.json`) on **2026-03-17**. Providers change prices; if this page looks stale, check the calculator and the provider’s official docs.
