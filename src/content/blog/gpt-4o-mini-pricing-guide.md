---
title: "GPT-4o mini pricing (input/output per 1M tokens)"
description: "Current OpenAI pricing for GPT-4o mini: input $0.15/1M tokens, output $0.60/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-04T00:00:00.000Z
topicId: "model-pricing-openai-gpt-4o-mini"
tags: ["pricing", "models", "openai", "gpt-4o-mini"]
faq:
  - q: "How much does GPT-4o mini cost?"
    a: "List price is $0.15/1M input tokens and $0.60/1M output tokens (USD)."
...
# GPT-4o mini pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **GPT-4o mini** (provider: **OpenAI**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $0.15 / 1M | Prompt + system + context |
| Output tokens | $0.60 / 1M | Model responses |
...
- **100k input + 20k output** ≈ $0.027 (input $0.015 + output $0.012)
- **1M input + 200k output** ≈ $0.27 (input $0.15 + output $0.12)
