---
title: "Claude Opus 4 (latest) pricing (input/output per 1M tokens)"
description: "Current Anthropic pricing for Claude Opus 4 (latest): input $15/1M tokens, output $75/1M — plus a quick way to estimate your bill in GPT Breeze."
pubDate: 2026-03-09T00:00:00.000Z
topicId: "model-pricing-anthropic-claude-opus-4-0"
tags: ["pricing", "models", "anthropic", "claude-opus-4-0"]
faq:
  - q: "How much does Claude Opus 4 (latest) cost?"
    a: "List price is $15/1M input tokens and $75/1M output tokens (USD)."
...
# Claude Opus 4 (latest) pricing (input/output per 1M tokens)
...
This page is the **current price sheet** for **Claude Opus 4 (latest)** (provider: **Anthropic**) and a practical way to estimate costs in GPT Breeze using your own usage pattern.

## Quick pricing (USD per 1M tokens)

| Item | Price | Notes |
|---|---:|---|
| Input tokens | $15 / 1M | Prompt + system + context |
| Output tokens | $75 / 1M | Model responses |
| Cache read | $1.50 / 1M | If provider supports cached inputs |
| Cache write | $18.75 / 1M | If provider charges to write cache |
...
- **100k input + 20k output** ≈ $3 (input $1.50 + output $1.50)
- **1M input + 200k output** ≈ $30 (input $15 + output $15)
